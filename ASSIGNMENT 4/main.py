...
products = [
    ...
    {"id": 2, "name": "Note Book", "price": 99, "category": "Electronics", "in_stock": True},
    {"id": 3, "name": "USB Hub", "price": 799,"category": "Accessories", "in_stock": False},
    {"id": 4, "name": "Pen Set", "price": 49, "category": "Stationery", "in_stock": True},
    {"id": 5, "name": "Monitor", "price": 12000, "category": "Electronics", "in_stock": False},

    # Newly added products
    {"id": 6, "name": "Key Board", "price" : 1500, "category": "Electronics", "in_stock": True},
    {"id": 7, "name": "Laptop", "price": 8000, "category": "Stationery", "in_stock": True},
...
#--------------------------------------------------------------------------------------------------------
#  View the Cart and Verify the Total
#-------------------------------------------------------------------------------------------------------
